...
#(2) Oryza sativa
geneminer.py  -1 data/SRR9663069_1.fastq -2 data/SRR9663069_2.fastq  -rtfa ref_Poaceae_353/ -o geneminer_out_Oryza_sativa -t 4 -k1 29 -k2 41 -limit_count auto
...
#(2) Oryza sativa
spades.py -1 data/SRR9663069_1.fastq -2 data/SRR9663069_2.fastq  -t 4 -m 50 -o spades_out_Oryza_sativa
